...
import { IdCard, BookOpenText, Users } from 'lucide-react'
...
export default function Home() {
  return (
    <main className="flex flex-col items-center justify-center left-0 right-0 top-0 bottom-0 absolute bg-primary-50">
      ...
      <h1 className="text-3xl font-bold">Googoo Card</h1>
      ...
      <div className="flex flex-col gap-4 px-6 py-6 w-full mt-auto">
