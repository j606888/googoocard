...
const Event = ({ event }: { event: EventType }) => {
  ...
  return (
    <div className="flex gap-3 w-full bg-neutral-50 border border-neutral-100 rounded-xl p-3">
      <div>
      ...
      <div className="text-xs text-neutral-400 ml-auto shrink-0">
